# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/001_utils_loss_functions.ipynb.

# %% auto 0
__all__ = ['pinball_loss', 'quantile_loss']

# %% ../nbs/001_utils_loss_functions.ipynb 3
...
# %% ../nbs/001_utils_loss_functions.ipynb 5
def pinball_loss(
            Y_true: np.ndarray,
            Y_pred: np.ndarray,
...
# %% ../nbs/001_utils_loss_functions.ipynb 6
def quantile_loss(
                Y_true: np.ndarray,
                Y_pred: np.ndarray,
