...
# %% auto 0
__all__ = ['RandomChoice', 'BaseEnvironment']
...
class RandomChoice:
    def __init__(self, size = 100000):
        self.seeds = range(size)
        self.counter = 0
        self.size = size
    
    def return_seed(self):
        seed = self.seeds[self.counter]
        self.counter += 1
...
class BaseEnvironment(gym.Env, ABC):
    ...
    def reset_index(self,
        ...
        print("resetted new env with seed:", seed, "and got index:", self.index)
