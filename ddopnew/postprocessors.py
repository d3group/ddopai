# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00_utils/02_postprocessors.ipynb.

# %% auto 0
__all__ = ['ClipAction', 'RoundAction']

# %% ../nbs/00_utils/02_postprocessors.ipynb 3
...
# %% ../nbs/00_utils/02_postprocessors.ipynb 5
class ClipAction:
    """
...
# %% ../nbs/00_utils/02_postprocessors.ipynb 6
class RoundAction:
    """
