...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/30_experiments/30_tracking.ipynb.

# %% auto 0
__all__ = ['get_git_hash', 'get_library_version']

# %% ../../nbs/30_experiments/30_tracking.ipynb 3
...
# %% ../../nbs/30_experiments/30_tracking.ipynb 4
def get_git_hash(
...
# %% ../../nbs/30_experiments/30_tracking.ipynb 6
