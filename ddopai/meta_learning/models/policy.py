# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/50_meta_learning/52_models/10_policy.ipynb.

# %% auto 0
__all__ = ['device', 'FixedCategorical', 'old_sample', 'log_prob_cat', 'FixedNormal', 'log_prob_normal', 'entropy', 'init',
           'init_normc_', 'total_num_params', 'linear_batched_weights', 'kaiming_uniform_with_gain',
           'kaiming_uniform_ignore_gain', 'HFI_bias_layer_init', 'HFI_weight_layer_init', 'init_hyper_match',
           'hyper_bias_layer_init', 'hyper_weight_layer_init', 'AddBias', 'Categorical', 'DiagGaussian', 'Policy']

# %% ../../../nbs/50_meta_learning/52_models/10_policy.ipynb 1
import gym
import math
import numpy as np
import torch
...
# %% ../../../nbs/50_meta_learning/52_models/10_policy.ipynb 2
...
# %% ../../../nbs/50_meta_learning/52_models/10_policy.ipynb 3
...
# %% ../../../nbs/50_meta_learning/52_models/10_policy.ipynb 4
...
# %% ../../../nbs/50_meta_learning/52_models/10_policy.ipynb 5
...
# %% ../../../nbs/50_meta_learning/52_models/10_policy.ipynb 6
...
# %% ../../../nbs/50_meta_learning/52_models/10_policy.ipynb 7
class Policy(nn.Module):
    def __init__(self,
        ...
        # set up initialisation of the policy
        ...
        # set up modules
        self.use_hyper = self.args.use_hypernet # Hypernetworks are used to produce the policy weights
        self.use_film = self.args.use_film # FiLM is a simplified Hypernet that only scales the activations of the policy
        self.multinet = self.args.multinet # separate net for each task, with one-hot representation of input task
