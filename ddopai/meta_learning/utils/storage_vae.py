# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/50_meta_learning/50_utils/30_storage_vae.ipynb.

# %% auto 0
__all__ = ['device', 'RolloutStorageVAE']

# %% ../../../nbs/50_meta_learning/50_utils/30_storage_vae.ipynb 1
import numpy as np
import torch

device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")

# %% ../../../nbs/50_meta_learning/50_utils/30_storage_vae.ipynb 2
