# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/50_meta_learning/51_algorithms/20_online_storage.ipynb.

# %% auto 0
__all__ = ['device', 'OnlineStorage']

# %% ../../../nbs/50_meta_learning/51_algorithms/20_online_storage.ipynb 1
import torch
from torch.utils.data.sampler import BatchSampler, SubsetRandomSampler

device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")

# %% ../../../nbs/50_meta_learning/51_algorithms/20_online_storage.ipynb 2
def _flatten_helper(T, N, _tensor):
    return _tensor.reshape(T * N, *_tensor.size()[2:])

# %% ../../../nbs/50_meta_learning/51_algorithms/20_online_storage.ipynb 3
