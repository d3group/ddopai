# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/50_meta_learning/51_algorithms/10_ppo.ipynb.

# %% auto 0
__all__ = ['device', 'none_or_zeros', 'normalize', 'get_mean_grad_norm', 'get_samples_by_task', 'PPO']

# %% ../../../nbs/50_meta_learning/51_algorithms/10_ppo.ipynb 1
import torch
...
# %% ../../../nbs/50_meta_learning/51_algorithms/10_ppo.ipynb 2
...
# %% ../../../nbs/50_meta_learning/51_algorithms/10_ppo.ipynb 3
class PPO:
    def __init__(self,
                 args,
                 actor_critic,
